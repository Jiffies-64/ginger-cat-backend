<!DOCTYPE html>
<!-- saved from url=(0048)http://localhost:8601/#/customer/activity-detail -->
<html lang="">
<head>
    ...
    <link rel="icon" href="http://localhost:8601/favicon.ico">
    <title>ginger-cat-user-merchant</title>
    <script defer="" src="./seckill_files/chunk-vendors.js.下载"></script>
    <script defer="" src="./seckill_files/app.js.下载"></script>
    <style type="text/css">
        /* Your global styles here */
    </style>
    <style type="text/css">
        .banner[data-v-6bc68010] {
            height: 122px; /* Adjust the height as needed */
            overflow: hidden; /* Ensure that overflow is hidden for swipe effect */
            border-radius: 10px;
        }

        .banner-image[data-v-6bc68010] {
            width: 100%;
            height: 100%;
            -o-object-fit: cover;
            object-fit: cover;
    ...
    <style type="text/css">
        ...
        .logo-img[data-v-ed558de2] {
            max-height: 44px;
        }

        .location[data-v-ed558de2] {
            margin-bottom: 3px;
        }

        .location-text[data-v-ed558de2] {
            font-size: 14px;
            font-weight: 500;
            margin-right: 5px;
        }

        .search-icon[data-v-ed558de2] {
            margin-right: 10px;
            margin-left: 10px;
        }

        .search-text[data-v-ed558de2] {
            height: 20px;
            flex: 1;
            font-size: 12px;
            line-height: 20px;
        ...
        .search-box-simulation[data-v-ed558de2] {
    ...
    <style type="text/css">
        ...
        .image-col[data-v-208083e0] {
            max-width: 25%;
        }

        .goods-image[data-v-208083e0] {
            width: 100%;
            height: auto;
            max-width: 100%;
            max-height: 100%;
        ...
        .info-col[data-v-208083e0] {
            padding: 0 10px;
        }

        .goods-name[data-v-208083e0] {
        ...
        .goods-extra-info[data-v-208083e0] {
            display: flex;
            justify-content: space-between;
            margin: 0;
            padding: 0;
        ...
        .goods-promotion[data-v-208083e0] {
        ...
        .bottom-row[data-v-208083e0] {
            font-size: 12px;
            color: #888888;
        }

        .add-to-cart-col[data-v-208083e0] {
            text-align: right;
        }

        .goods-progress-bar[data-v-208083e0] {
            width: 100%;
            height: 6px;
            border-radius: 10px;
        ...
        .goods-progress-bar div[data-v-208083e0] {
            height: 100%;
            border-radius: 10px;
            background-color: #fa8a19;
        }

        .goods-remaining-info[data-v-208083e0] {
        }

        .goods-remaining[data-v-208083e0] {
            padding: 0;
            margin: 0;
        }

        .goods-order-time[data-v-208083e0] {
            margin: 0;
            padding: 0;
        }

        .add-to-cart[data-v-208083e0] {
            background-color: #fa8a19;
            color: #fff;
            border: none;
            border-radius: 14px;
    ...
    <style type="text/css">
        /* Your goods list styles here */
        .goods-list[data-v-0c7593ca] {
            display: flex;
            flex-wrap: wrap;
            justify-content: space-between;
            padding: 0;
    ...
    <style type="text/css">
        /* Your goods page styles here */
        .goods[data-v-2a158868] {
            padding: 0;
        }
    </style>
    <style type="text/css">
        /* Your home page styles here */
        .home[data-v-017f5704] {
            padding: 14px;
            background: linear-gradient(to bottom, #ff8355 22vh, #f0f0f0 30vh);
        }

        .icon-row[data-v-017f5704] {
            margin: 10px 0 10px;
        }

        .icon-column[data-v-017f5704] {
            margin: 0 auto;
            display: flex;
        ...
        .icon-description[data-v-017f5704] {
            text-align: center;
            font-size: 8px;
            color: #888888;
            margin: 0;
    ...
    <style type="text/css">
        .order-title[data-v-4090d400] {
            padding: 10px 10px 0;
            background-color: #fff;
            border-radius: 10px 10px 0 0;
        }

        .order-row[data-v-4090d400] {
        ...
        .image-col[data-v-4090d400] {
            max-width: 25%;
        }

        .order-image[data-v-4090d400] {
            width: 100%;
            height: auto;
            max-width: 100%;
            max-height: 100%;
        ...
        .info-col[data-v-4090d400] {
            padding: 0 10px;
        }

        .order-name[data-v-4090d400] {
            font-size: 18px; /* 调整字体大小 */
            margin: 0;
            padding: 0;
        }

        .order-extra-info[data-v-4090d400] {
            display: flex;
            justify-content: space-between;
            margin: 0;
            padding: 0;
        ...
        .order-promotion[data-v-4090d400] {
            display: inline-block;
            margin: 0 0 10px;
            padding: 1px 5px;
            border-radius: 2px;
        ...
        .order-progress-bar div[data-v-4090d400] {
            height: 100%;
            border-radius: 10px;
            background-color: #fa8a19;
        }

        .divider[data-v-4090d400] {
            margin: 2px;
            background-color: #fff;
        }
    </style>
    ...
    <style type="text/css">
        .order-list-wrapper[data-v-2a216900] {
            padding: 60px 10px 10px 10px;
            height: 100vh;
            background-color: #f0f0f0;
        }

        .order-list-header[data-v-2a216900] {
            padding-top: 20px;
            position: fixed;
            width: 100%;
            background-color: #fff;
        ...
        .order[data-v-2a216900] {
            margin-bottom: 40px;
        }
    </style>
    <style type="text/css">
        /* Your order page styles here */
    </style>
    <style type="text/css">
        /* Your order page styles here */
    </style>
    <style type="text/css">
        .user-page[data-v-69d1d0fe] {
            padding: 20px 14px 14px 14px;
            height: 100vh;
            background-color: #f0f0f0;
        }

        .merchant-join[data-v-69d1d0fe] {
            height: 20px;
            border-radius: 4px;
            background-color: #ff4d00;
        }

        .merchant-join-text[data-v-69d1d0fe] {
            font-weight: 800;
            color: #ffffff;
            font-size: 12px;
            line-height: 20px;
        ...
        .header[data-v-69d1d0fe] {
            display: flex;
            justify-content: flex-end;
            padding: 10px;
        }

        .icon[data-v-69d1d0fe] {
            font-size: 20px;
            margin-left: 10px;
            cursor: pointer;
        }

        .user-info[data-v-69d1d0fe] {
            display: flex;
            align-items: center;
            margin: 20px 0;
        }

        .avatar[data-v-69d1d0fe] {
            width: 50px;
            height: 50px;
            border-radius: 50%;
            margin-right: 10px;
        ...
        .user-details[data-v-69d1d0fe] {
            flex: 1;
        }

        .user-name[data-v-69d1d0fe] {
            font-size: 16px;
            font-weight: bold;
        }

        .user-id[data-v-69d1d0fe],
        .user-phone[data-v-69d1d0fe] {
            font-size: 14px;
            color: #888;
        }

        .service-row[data-v-69d1d0fe] {
            display: flex;
            justify-content: space-between;
            margin-bottom: 10px;
        }

        .service-icon[data-v-69d1d0fe] {
            font-size: 28px;
            margin-bottom: 10px;
        }

        .service-description[data-v-69d1d0fe] {
            font-size: 12px;
            font-weight: 300;
            text-align: center;
        }

        .large-large-large-bold[data-v-69d1d0fe] {
            margin-right: 10px;
            font-weight: 600;
            font-size: 24px;
            color: #333333;
        ...
        .large-large-bold[data-v-69d1d0fe] {
            margin-right: 10px;
            font-weight: 600;
            font-size: 20px;
            color: #333333;
        ...
        .orange[data-v-69d1d0fe] {
            color: orange;
        }

        .my-button[data-v-69d1d0fe] {
    ...
    <style type="text/css">
        /* Your component styles here */
        .search-box[data-v-64e521b6] {
            display: flex;
            align-items: center;

            input[data-v-64e521b6] {
                flex: 1;
                margin-right: 10px;
            }

            button[data-v-64e521b6] {
                padding: 5px 10px;
            }
        }

        .goods-list-wrapper[data-v-64e521b6] {
            padding: 10px;
            height: 100vh;
            background-color: #f0f0f0;
        }
    ...
    <style type="text/css">
        .overflow-ellipsis[data-v-539d3684] {
            white-space: nowrap;
            overflow: hidden;
            text-overflow: ellipsis;
        }

        .user-page[data-v-539d3684] {
            padding: 30px 14px 14px 14px;
            height: 100vh;
            background-color: #f0f0f0;
        }

        .merchant-join[data-v-539d3684] {
            height: 20px;
            border-radius: 4px;
            background-color: #ff4d00;
        }

        .merchant-join-text[data-v-539d3684] {
            font-weight: 800;
            color: #ffffff;
            font-size: 12px;
            line-height: 20px;
        ...
        .header[data-v-539d3684] {
            display: flex;
            justify-content: flex-end;
            padding: 10px;
        }

        .icon[data-v-539d3684] {
            font-size: 20px;
            margin-left: 10px;
            cursor: pointer;
        }

        .user-info[data-v-539d3684] {
            display: flex;
        ...
        .user-details[data-v-539d3684] {
            flex: 1;
        }

        .user-name[data-v-539d3684] {
            font-size: 16px;
            font-weight: bold;
        }

        .user-id[data-v-539d3684],
        .user-phone[data-v-539d3684] {
            font-size: 14px;
            color: #888;
        }

        .recharge[data-v-539d3684] {
        ...
        .service-row[data-v-539d3684] {
            display: flex;
            justify-content: space-between;
            margin-bottom: 10px;
        }

        .service-icon[data-v-539d3684] {
            font-size: 28px;
            margin-bottom: 10px;
        }

        .service-description[data-v-539d3684] {
            font-size: 12px;
            font-weight: 300;
            text-align: center;
        }

        .large-large-large-bold[data-v-539d3684] {
            margin-right: 10px;
            font-weight: 600;
            font-size: 24px;
            color: #333333;
        ...
        .large-large-bold[data-v-539d3684] {
            margin-right: 10px;
            font-weight: 600;
            font-size: 20px;
            color: #333333;
        ...
        .orange[data-v-539d3684] {
            color: orange;
        }

        .my-button[data-v-539d3684] {
            border: 1px orange solid;
            color: orange;
            font-size: 12px;
            line-height: 20px;
    ...
    <style type="text/css">
        .header[data-v-4f6856f2] {
            margin-top: 20px;
            margin-bottom: 10px;
        }

        .goods-title[data-v-4f6856f2] {
            margin: 0;
        }

        .goods-address[data-v-4f6856f2] {
            margin: 0 0 10px;
            color: #888888;
        }

        .activity-requirements[data-v-4f6856f2] {
            margin-bottom: 10px;
        }
        ...
        .notice[data-v-4f6856f2] {
            margin-bottom: 40px;
        }

        .large-bold[data-v-4f6856f2] {
            margin-right: 10px;
            font-weight: 600;
            font-size: 16px;
            color: #333333;
    ...
    <style type="text/css">
        ...
        .image-col[data-v-35a41162] {
            max-width: 25%;
        }

        .shop-image[data-v-35a41162] {
            width: 100%;
            height: auto;
            max-width: 100%;
            max-height: 100%;
        ...
        .info-col[data-v-35a41162] {
            padding: 0 10px;
        }

        .shop-name[data-v-35a41162] {
            font-size: 18px; /* 调整字体大小 */
            margin: 0;
            padding: 0;
            color: #222222;
        ...
        .shop-extra-info[data-v-35a41162] {
            display: flex;
            justify-content: space-between;
            margin: 5px 0;
            padding: 0;
        ...
        .large-large-large-bold[data-v-35a41162] {
            margin-right: 10px;
            font-weight: 600;
            font-size: 24px;
            color: #333333;
        ...
        .large-large-bold[data-v-35a41162] {
            margin-right: 10px;
            font-weight: 600;
            font-size: 20px;
            color: #333333;
        ...
        .orange[data-v-35a41162] {
            color: orange;
        }

        .shop-progress-bar div[data-v-35a41162] {
            height: 100%;
            border-radius: 10px;
            background-color: #fa8a19;
        }
    ...
    <style type="text/css">
        /* Your shop list styles here */
        .shop-list[data-v-3fa9896d] {
            display: flex;
            flex-wrap: wrap;
            justify-content: space-between;
            padding: 0;
    ...
    <style type="text/css">
        /* Your component styles here */
        .search-box[data-v-62c9f36e] {
            display: flex;
            align-items: center;

            input[data-v-62c9f36e] {
                flex: 1;
                margin-right: 10px;
            }

            button[data-v-62c9f36e] {
                padding: 5px 10px;
            }
        }

        .shop-list-wrapper[data-v-62c9f36e] {
            padding: 10px;
            height: 100vh;
            background-color: #f0f0f0;
        }
...
<body>
<noscript>
    <strong>We're sorry but ginger-cat-user-merchant doesn't work properly without JavaScript enabled. Please enable it
        to continue.</strong>
</noscript>
<div>
    <div data-v-4f6856f2="" class="header">
        <div data-v-4f6856f2="" class="van-nav-bar van-hairline--bottom">
            <div class="van-nav-bar__content">
                <div class="van-nav-bar__left"><i class="van-icon van-icon-arrow-left van-nav-bar__arrow"><!----></i>
                </div>
                <div class="van-nav-bar__title van-ellipsis">活动详情</div>
            </div>
        </div>
        <div data-v-4f6856f2="" class="van-card">
            <div data-v-4f6856f2="" class="van-card__header"><a data-v-4f6856f2="" class="van-card__thumb">
                    <div data-v-4f6856f2="" class="van-image" style="width: 100%; height: 100%;"><img
                                src="./seckill_files/ipad.jpeg" class="van-image__img" style="object-fit: cover;"></div>
                </a>
                <div data-v-4f6856f2="" class="van-card__content">
                    <div data-v-4f6856f2=""><h3 data-v-4f6856f2="" class="goods-title">
                            ${model.shop.shopName}</h3>
                        <div data-v-4f6856f2="" class="goods-address"><span data-v-4f6856f2="">${model.shop.shopAddress}</span></div>
                        <span data-v-4f6856f2="" class="van-tag van-tag--plain van-tag--warning">先付后返</span><span
                                data-v-4f6856f2="" class="van-tag van-tag--mark van-tag--warning"
                                style="margin-right: 10px;">${model.rebate.rebateDetails}</span><span data-v-4f6856f2=""
                                                                                 class="van-tag van-tag--plain van-tag--warning">图文反馈</span>
                    </div>
                </div>
            </div>
            <div data-v-4f6856f2="" class="van-card__footer">
                <button data-v-4f6856f2="" class="van-button van-button--default van-button--small"
                        style="margin-top: 10px;">
                    <div data-v-4f6856f2="" class="van-button__content"><span data-v-4f6856f2=""
                                                                              class="van-button__text">复制关键词</span>
                    </div>
                </button>
                <button data-v-4f6856f2="" class="van-button van-button--default van-button--small">
                    <div data-v-4f6856f2="" class="van-button__content"><span data-v-4f6856f2=""
                                                                              class="van-button__text">是否可配送</span>
                    </div>
                </button>
                <button data-v-4f6856f2="" class="van-button van-button--default van-button--small">
                    <div data-v-4f6856f2="" class="van-button__content"><span data-v-4f6856f2=""
                                                                              class="van-button__text">失败上报</span>
                    </div>
                </button>
            </div>
        </div>
        <div data-v-4f6856f2="" class="van-card">
            <div data-v-4f6856f2="" class="van-card__header">
                <div data-v-4f6856f2="" class="van-card__content">
                    <div data-v-4f6856f2="">
                        <div data-v-4f6856f2="" class="small-thin activity-requirements"><span data-v-4f6856f2=""
                                                                                               class="large-bold">活动要求</span>先抢名额后点餐
                        </div>
                        <div data-v-4f6856f2="" class="k-v"><span data-v-4f6856f2=""
                                                                  class="normal-thin">平台</span><span
                                    data-v-4f6856f2="" class="normal-bold">美团</span><span data-v-4f6856f2=""
                                                                                            class="normal-bold">剩余名额3份</span>
                        </div>
                        <div data-v-4f6856f2="" class="k-v"><span data-v-4f6856f2=""
                                                                  class="normal-thin">要求</span><span
                                    data-v-4f6856f2="" class="normal-bold">用餐反馈（需含字含图)﹔多图多字</span></div>
                        <div data-v-4f6856f2="" class="k-v"><span data-v-4f6856f2=""
                                                                  class="normal-thin">返利</span><span
                                    data-v-4f6856f2=""
                                    class="normal-bold">实付满20返10(每单最多含1瓶酒水，饮品店除外)</span>
                        </div>
                    </div>
                    <div data-v-4f6856f2="" class="van-card__bottom">
                        <div data-v-4f6856f2="" class="k-v large-bold"> 本次活动需消耗</div>
                        <div data-v-4f6856f2="" class="k-v"><span data-v-4f6856f2="" class="normal-thin">橘猫红包</span><span
                                    data-v-4f6856f2="" class="small-thin">暂无可用</span></div>
                        <div data-v-4f6856f2="" class="k-v"><span data-v-4f6856f2="" class="normal-thin">橘猫卡券</span><span
                                    data-v-4f6856f2="" class="small-thin">1张饭票</span></div>
                    </div>
                </div>
            </div>
        </div>
        <div data-v-4f6856f2="" class="van-card">
            <div data-v-4f6856f2="" class="van-card__header">
                <div data-v-4f6856f2="" class="van-card__content">
                    <div data-v-4f6856f2="">
                        <div data-v-4f6856f2="" class="notice">
                            <div data-v-4f6856f2="" class="rule"><h2 data-v-4f6856f2="">报名须知</h2>
                                <h3 data-v-4f6856f2="">参与规则:</h3>
                                <ol data-v-4f6856f2="">
                                    <li data-v-4f6856f2="">1.<span data-v-4f6856f2=""
                                                                   class="orange">先抢名额再下单</span>，确认报名成功后再去下单;
                                    </li>
                                    <li data-v-4f6856f2="">2.<span data-v-4f6856f2=""
                                                                   class="orange">下单前请核对下单店铺和平台</span>，下错店铺或者下错平台不能参与活动;
                                    </li>
                                    <li data-v-4f6856f2="">3.实付金额需满足满返条件，实付不满扣差后向上取整返豆;</li>
                                    <li data-v-4f6856f2="">4.满返活动不叠加、不累计参与，<span data-v-4f6856f2=""
                                                                                             class="orange">单笔订单只能参与一次</span>;
                                    </li>
                                    <li data-v-4f6856f2="">
                                        5.同一店铺活动当天仅限参与一次;同一会员账号，当天最多参与5次活动。
                                    </li>
                                    <li data-v-4f6856f2="">
                                        6.抢单时间非店铺营业时间，距离非商家配送范围,仅作为参考，具体以下单平台商家店铺展示信息为准;
                                    </li>
                                </ol>
                            </div>
                            <div data-v-4f6856f2="" class="rule"><h3 data-v-4f6856f2="">提交规则:</h3>
                                <ol data-v-4f6856f2="">
                                    <li data-v-4f6856f2="">1.订单号需在报名成功后<span data-v-4f6856f2=""
                                                                                       class="orange">1小时内上传，超时名额取消，点击“领红包并确定报名”可延长2小时</span>;
                                    </li>
                                    <li data-v-4f6856f2="">2.用餐凭证应最晚于抢名额的<span data-v-4f6856f2=""
                                                                                           class="orange">次日11点前提交</span>，超时将无法提交，参与失败;
                                    </li>
                                    <li data-v-4f6856f2="">3.满返活动<span data-v-4f6856f2="" class="orange">应在规定时间完成，超时未提交订单，参与失败</span>;
                                    </li>
                                    <li data-v-4f6856f2="">4.审核驳回订单可在抢名额的<span data-v-4f6856f2=""
                                                                                           class="orange">次日12点前重新上传，超时未上传或上传资料不符合参与失败</span>;
                                    </li>
                                    <li data-v-4f6856f2="">5.<span data-v-4f6856f2=""
                                                                   class="orange">手动取消或超时取消</span>，视为参与活动失败;
                                    </li>
                                </ol>
                            </div>
                            <div data-v-4f6856f2="" class="rule"><h3 data-v-4f6856f2="">蚕豆扣减规则:</h3>
                                <ol data-v-4f6856f2="">
                                    <li data-v-4f6856f2=""> 1.按照活动要求并参照示例图上传凭证，<span data-v-4f6856f2=""
                                                                                                     class="orange">字图不可拼凑;图文不符或缺少</span>将扣5铃铛/图或/字;<span
                                                data-v-4f6856f2=""
                                                class="orange">提交非实际收到餐品图，或只提交外包装图等</span>，将扣5铃铛;
                                    </li>
                                    <li data-v-4f6856f2=""> 2.实付不满将扣差后向上取整返豆;<span data-v-4f6856f2=""
                                                                                                 class="orange">实付金额仅包含购买商家餐品的实际付款金额，不包含购买平台的任何卡券、商品，如购美团会员、美团加量包、代金券、超值优惠券包、准时宝，神券省钱包</span>等;
                                    </li>
                                    <li data-v-4f6856f2="">
                            ...
                            <div data-v-4f6856f2="" class="rule"><h3 data-v-4f6856f2="">禁止行为说明:</h3>
                                <ol data-v-4f6856f2="">
                                    <li data-v-4f6856f2="">1.<span data-v-4f6856f2="" class="orange">禁止多平台返现,禁止预订单，禁止向商家要求返现，禁止虚假P图行为</span>;
                                    </li>
                                    <li data-v-4f6856f2="">2.<span data-v-4f6856f2=""
                                                                   class="orange">禁止退款订单/理赔订单参与</span>，如因退款或者理赔行为致使实付金额不满的，请将差额部分铃铛退回;
                                    </li>
                                </ol>
                            </div>
                            <div data-v-4f6856f2="" class="rule"><h3 data-v-4f6856f2="">卡券使用说明:</h3>
                                <p data-v-4f6856f2="">
                                    所有卡券仅限使用一次，一经使用即失效;卡券不退不换不补;卡券请在有效期内使用，超期失效;</p>
                            </div>
                            <div data-v-4f6856f2="" class="rule"><h3 data-v-4f6856f2="">饮品限制说明:</h3>
                                <div data-v-4f6856f2="">除饮品店外，<span data-v-4f6856f2="" class="orange">单笔订单最多可随主食下单1瓶饮料</span>;单点饮品或者下单多件饮品的，将按照实付不满扣差返豆规则处理;
                                </div>
                            </div>
                            <div data-v-4f6856f2="" class="rule"><h3 data-v-4f6856f2="">用餐评价要求:</h3>
                                <div data-v-4f6856f2=""> 真实用餐反馈即可，拒绝<span data-v-4f6856f2="" class="orange">注水，文字敷衍，复制粘贴</span>等行为，建议下单当天及时给到用餐反馈，以免后续遗忘活动参与失败;
                                </div>
                            </div>
                            <div data-v-4f6856f2="" class="rule"><h3 data-v-4f6856f2="">温馨提示︰</h3>
                                <ol data-v-4f6856f2="">
                                    <li data-v-4f6856f2="">1.注意时间限制，超时订单，无法获取返豆;</li>
                                    <li data-v-4f6856f2="">2.注意活动说明备注，仅限公里之内的订单参与活动;</li>
                                    <li data-v-4f6856f2="">
                                        3.参与活动请诚实守信．遵守规则，提交真实、完整、客观、全面的反馈;
                                    </li>
                                    <li data-v-4f6856f2="">
                                        4.以上规则如有不明可在《平台规则》中查看详情，或资询在线人工客服。
                                    </li>
                                </ol>
                            </div>
                        </div>
        ...
        <div data-v-4f6856f2="" class="van-goods-action">
            <div data-v-4f6856f2="" role="button" tabindex="0" class="van-goods-action-icon">
                <div class="van-icon van-icon-home-o van-goods-action-icon__icon"><!----></div>
                首页
            </div>
            <div data-v-4f6856f2="" role="button" tabindex="0" class="van-goods-action-icon">
                <div class="van-icon van-icon-chat-o van-goods-action-icon__icon"><!----></div>
                客服
            </div>
            <button data-v-4f6856f2=""
                    class="van-button van-button--warning van-button--large van-goods-action-button van-goods-action-button--first van-goods-action-button--last van-goods-action-button--warning">
                <div class="van-button__content"><span class="van-button__text">立即抢单</span></div>
            </button>
        </div>
    </div>
</div>
...
<div class="van-toast van-toast--middle van-toast--fail" style="z-index: 2001; display: none;"><i
            class="van-icon van-icon-fail van-toast__icon"><!----></i>
    <div class="van-toast__text">Request failed with status code 502</div>
</div>
</body>
</html>